...
namespace DaikonForge.VoIP
{
	...
	public class ChunkBuffer
	{
		...
		{
			samples.EnsureCapacity( samples.Count + incomingSamples.Length );
			incomingSamples.CopyTo( 0, samples.Items, samples.Count, incomingSamples.Length * 4 );
			samples.ForceCount( samples.Count + incomingSamples.Length );
		}
